...
/** Génère les liens streaming côté client si le backend ne les fournit pas */
function getStreaming(rec) {
  if (rec.streaming) return rec.streaming;
  ...
  return createPortal(
    <div className={`rec-modal-backdrop theme-${theme}`} onClick={onClose}>
      <div className="rec-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="rec-modal-cover">
          {rec.cover_url
            ? <img src={rec.cover_url} alt={rec.title} />
            : (
              <div className="rec-modal-cover-placeholder">
        ...
        {/* Infos + streaming */}
        <div className="rec-modal-bottom">
          ...
          <div className="rec-modal-info">
            ...
            <p className="rec-modal-artist">{rec.artist}</p>
          </div>

          {/* Petits boutons icône */}
          <div className="rec-modal-streaming">
            <p className="result-section-label">{t(lang, "streaming")}</p>
            <div className="streaming-icon-row">
